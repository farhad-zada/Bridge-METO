...
contract Lock is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    mapping(address => uint256[]) private transfersOut;
    mapping(address => uint256[]) private transfersIn;
    ...
    function send(
        ...
        soto.transferFrom(msg.sender, address(this), amount);
